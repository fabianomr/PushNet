...
namespace MoonAPNS
{
  public class PushNotification
  {
    ...
    public PushNotification(bool useSandbox, string p12File, string p12FilePassword)
    {
      ...
      /*
         link: http://forum.arvixe.com/smf/open-discussions/is-iphone-push-notifications-using-a-p12-cert-on-shared-server-possible/
      ...
      */
      _certificate = string.IsNullOrEmpty(p12FilePassword) ? 
          new X509Certificate2(File.ReadAllBytes(p12File), "", X509KeyStorageFlags.MachineKeySet) : 
